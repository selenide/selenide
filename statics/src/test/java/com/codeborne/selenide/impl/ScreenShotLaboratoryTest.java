...
class ScreenShotLaboratoryTest implements WithAssertions {
  ...
  @Test
  void canGetCurrentThreadLatestScreenshot(){
    assertThat(screenshots.currentContext.get()).hasToString("");
    assertThat(screenshots.getCurrentThreadLatestScreenshot()).isNull();

    screenshots.startContext("ui/MyTest/test_current_last_1/");
    screenshots.takeScreenShot(null);
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadLatestScreenshot())
      .isEqualTo(new File("ui/MyTest/test_current_last_1/12356789.1"));
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadLatestScreenshot())
      .isEqualTo(new File("ui/MyTest/test_current_last_1/12356789.2"));


    screenshots.startContext("ui/MyTest/test_current_last_2/");
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadLatestScreenshot())
      .isEqualTo(new File("ui/MyTest/test_current_last_2/12356789.3"));
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadLatestScreenshot())
      .isEqualTo(new File("ui/MyTest/test_current_last_2/12356789.4"));
  ...
  @Test
  void collectCurrentThreadAllScreenshots(){
    assertThat(screenshots.currentContext.get()).hasToString("");
    assertThat(screenshots.getCurrentThreadAllScreenshots()).isNull();

    screenshots.startContext("ui/MyTest/test_current_all_1/");
    screenshots.takeScreenShot(null);
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadAllScreenshots()).hasSize(2);

    screenshots.startContext("ui/MyTest/test_current_all_2/");
    screenshots.takeScreenShot(null);
    screenshots.takeScreenShot(null);
    screenshots.takeScreenShot(null);
    assertThat(screenshots.getCurrentThreadAllScreenshots()).hasSize(3);
    screenshots.finishContext();
    assertThat(screenshots.getCurrentThreadAllScreenshots()).isNull();
  }
}