...
final class FileDownloadToFolderTest extends IntegrationTest {
  ...
  void downloadMultipleFiles_errorMessage() {
    ...
    assertThatThrownBy(() -> $("#multiple-downloads").downloadFiles(files(22).withTimeout(500)))
      .isInstanceOf(FileNotDownloadedError.class)
      .hasMessageStartingWith("Failed to download at least 22 files in 500ms (found ")
