...
Selenide is a Java framework providing a concise fluent API for Selenium WebDriver. It simplifies writing browser-based automated tests. Current version: 7.18.1, requires Java 17+.
