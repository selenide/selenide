...
http://www.jetbrains.com/idea/docs/logo_intellij_idea.png http://selenide.org/images/yourkit.png

== License
Selenide is open-source project, and distributed under the MIT[http://choosealicense.com/licenses/mit/] license

http://travis-ci.org/codeborne/selenide.svg
