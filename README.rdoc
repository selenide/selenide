...
Until tutorial is ready, you can find some Selenide usages in the example project Hangman:
https://github.com/asolntsev/hangman/blob/master/selenide_1_9/test/ee/uitest/HangmanSpec.java
