...
### Tagging selenide
git tag -a selenide-2.10 -m "Created tag selenide-2.10"
...
selenide> mkdir ../selenide-web/javadoc/2.10/
selenide> mv build/docs/javadoc/* ../selenide-web/javadoc/2.10/
selenide-web> git add javadoc/2.10
