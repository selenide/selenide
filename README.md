...
### Tagging selenide
git tag -a selenide-2.9 -m "Created tag selenide-2.9"
...
selenide> mkdir ../selenide-web/javadoc/2.9/
selenide> mv build/docs/javadoc/* ../selenide-web/javadoc/2.9/
selenide-web> git add javadoc/2.9
