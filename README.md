...
### Tagging selenide
git tag -a selenide-3.1 -m "Create tag selenide-3.1"
...
selenide> mkdir ../selenide-web/javadoc/3.0/
selenide> mv build/docs/javadoc/* ../selenide-web/javadoc/3.0/
selenide-web> git add javadoc/3.0
