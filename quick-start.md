...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.7/selenide-3.7.jar">selenide.jar</a> to your project and you are done.<br/>
