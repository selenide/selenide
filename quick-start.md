...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.5/selenide-3.5.jar">selenide.jar</a> to your project and you are done.<br/>
