...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.5.1/selenide-3.5.1.jar">selenide.jar</a> to your project and you are done.<br/>
