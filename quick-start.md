...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.9.3/selenide-3.9.3.jar">selenide.jar</a> to your project and you are done.<br/>
