...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.9.1/selenide-3.9.1.jar">selenide.jar</a> to your project and you are done.<br/>
