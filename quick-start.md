...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/2.6.2/selenide-2.6.2.jar">selenide.jar</a> to your project and you are done.<br/>
...
<ivy-module>
  <dependencies>
    <dependency org="com.codeborne" name="selenide" rev="2.6.2"/>
  </dependencies>
</ivy-module>
```
