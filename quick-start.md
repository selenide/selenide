...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/3.2/selenide-3.2.jar">selenide.jar</a> to your project and you are done.<br/>
