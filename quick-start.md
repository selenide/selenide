...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/2.6.1/selenide-2.6.1.jar">selenide.jar</a> to your project and you are done.<br/>
...
<ivy-module>
  <dependencies>
    <dependency org="com.codeborne" name="selenide" rev="2.6.1"/>
  </dependencies>
</ivy-module>
```
...
```groovy
dependencies {
  testCompile 'com.codeborne:selenide:2.6.1'
}
```
