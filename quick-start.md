...
header-text: >
  ...
  Just add <a href="http://search.maven.org/remotecontent?filepath=com/codeborne/selenide/2.12/selenide-2.12.jar">selenide.jar</a> to your project and you are done.<br/>
