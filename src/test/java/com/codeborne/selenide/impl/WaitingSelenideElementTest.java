...
public class WaitingSelenideElementTest {
  ...
  public void testToString() {
    ...
    assertEquals("{By.id: app, in: table}", new WaitingSelenideElement(parent, By.id("app"), 0).toString());
    assertEquals("{By.id: app, in: table, index: 3}", new WaitingSelenideElement(parent, By.id("app"), 3).toString());
  }
}
