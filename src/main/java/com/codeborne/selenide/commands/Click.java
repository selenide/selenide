...
public class Click implements Command<Void> {
  ...
  public Void execute(SelenideElement proxy, WebElementSource locator, Object[] args) {
    if (args == null || args.length == 0) {
      click(locator.driver(), locator.findAndAssertElementIsVisibleOrTransparent());
    }
    else if (args.length == 2) {
      click(locator.driver(), locator.findAndAssertElementIsVisibleOrTransparent(), (int) args[0], (int) args[1]);
    }
    return null;
  }
