...
public class TstInfo  implements java.io.Serializable {
    ...
    private com.codeborne.security.digidoc.CertificateInfo certificate;
    ...
    public TstInfo(
           ...
           com.codeborne.security.digidoc.CertificateInfo certificate) {
           this.id = id;
           this.type = type;
     ...
     * @return certificate
     */
    public com.codeborne.security.digidoc.CertificateInfo getCertificate() {
        return certificate;
    }
     ...
     * @param certificate
     */
    public void setCertificate(com.codeborne.security.digidoc.CertificateInfo certificate) {
        this.certificate = certificate;
    }
