...
public class SignatureInfo  implements java.io.Serializable {
    ...
    private com.codeborne.security.digidoc.Error error;

    private java.util.Calendar signingTime;

    private com.codeborne.security.digidoc.SignerRole[] signerRole;

    private com.codeborne.security.digidoc.SignatureProductionPlace signatureProductionPlace;

    private com.codeborne.security.digidoc.SignerInfo signer;

    private com.codeborne.security.digidoc.ConfirmationInfo confirmation;

    private com.codeborne.security.digidoc.TstInfo[] timestamps;

    private com.codeborne.security.digidoc.CRLInfo CRLInfo;
    ...
    public SignatureInfo(
           ...
           com.codeborne.security.digidoc.Error error,
           java.util.Calendar signingTime,
           com.codeborne.security.digidoc.SignerRole[] signerRole,
           com.codeborne.security.digidoc.SignatureProductionPlace signatureProductionPlace,
           com.codeborne.security.digidoc.SignerInfo signer,
           com.codeborne.security.digidoc.ConfirmationInfo confirmation,
           com.codeborne.security.digidoc.TstInfo[] timestamps,
           com.codeborne.security.digidoc.CRLInfo CRLInfo) {
           this.id = id;
           this.status = status;
           this.error = error;
     ...
     * @return error
     */
    public com.codeborne.security.digidoc.Error getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(com.codeborne.security.digidoc.Error error) {
        this.error = error;
    }
     ...
     * @return signerRole
     */
    public com.codeborne.security.digidoc.SignerRole[] getSignerRole() {
        return signerRole;
    }
     ...
     * @param signerRole
     */
    public void setSignerRole(com.codeborne.security.digidoc.SignerRole[] signerRole) {
        this.signerRole = signerRole;
    }

    public com.codeborne.security.digidoc.SignerRole getSignerRole(int i) {
        return this.signerRole[i];
    }

    public void setSignerRole(int i, com.codeborne.security.digidoc.SignerRole _value) {
     ...
     */
    public com.codeborne.security.digidoc.SignatureProductionPlace getSignatureProductionPlace() {
        return signatureProductionPlace;
    }
     ...
     */
    public void setSignatureProductionPlace(com.codeborne.security.digidoc.SignatureProductionPlace signatureProductionPlace) {
        this.signatureProductionPlace = signatureProductionPlace;
    }
     ...
     * @return signer
     */
    public com.codeborne.security.digidoc.SignerInfo getSigner() {
        return signer;
    }
     ...
     * @param signer
     */
    public void setSigner(com.codeborne.security.digidoc.SignerInfo signer) {
        this.signer = signer;
    }
     ...
     * @return confirmation
     */
    public com.codeborne.security.digidoc.ConfirmationInfo getConfirmation() {
        return confirmation;
    }
     ...
     * @param confirmation
     */
    public void setConfirmation(com.codeborne.security.digidoc.ConfirmationInfo confirmation) {
        this.confirmation = confirmation;
    }
     ...
     * @return timestamps
     */
    public com.codeborne.security.digidoc.TstInfo[] getTimestamps() {
        return timestamps;
    }
     ...
     * @param timestamps
     */
    public void setTimestamps(com.codeborne.security.digidoc.TstInfo[] timestamps) {
        this.timestamps = timestamps;
    }

    public com.codeborne.security.digidoc.TstInfo getTimestamps(int i) {
        return this.timestamps[i];
    }

    public void setTimestamps(int i, com.codeborne.security.digidoc.TstInfo _value) {
     ...
     * @return CRLInfo
     */
    public com.codeborne.security.digidoc.CRLInfo getCRLInfo() {
        return CRLInfo;
    }
     ...
     * @param CRLInfo
     */
    public void setCRLInfo(com.codeborne.security.digidoc.CRLInfo CRLInfo) {
        this.CRLInfo = CRLInfo;
    }
