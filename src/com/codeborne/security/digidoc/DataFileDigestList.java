...
public class DataFileDigestList  implements java.io.Serializable {
    private com.codeborne.security.digidoc.DataFileDigest[] dataFileDigest;

    public DataFileDigestList() {
    }

    public DataFileDigestList(
           com.codeborne.security.digidoc.DataFileDigest[] dataFileDigest) {
     ...
     */
    public com.codeborne.security.digidoc.DataFileDigest[] getDataFileDigest() {
        return dataFileDigest;
    }
     ...
     */
    public void setDataFileDigest(com.codeborne.security.digidoc.DataFileDigest[] dataFileDigest) {
        this.dataFileDigest = dataFileDigest;
    }

    public com.codeborne.security.digidoc.DataFileDigest getDataFileDigest(int i) {
        return this.dataFileDigest[i];
    }

    public void setDataFileDigest(int i, com.codeborne.security.digidoc.DataFileDigest _value) {
