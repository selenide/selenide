...
public class SignatureModulesArray  implements java.io.Serializable {
    private com.codeborne.security.digidoc.SignatureModule[] modules;

    public SignatureModulesArray() {
    }

    public SignatureModulesArray(
           com.codeborne.security.digidoc.SignatureModule[] modules) {
     ...
     * @return modules
     */
    public com.codeborne.security.digidoc.SignatureModule[] getModules() {
        return modules;
    }
     ...
     * @param modules
     */
    public void setModules(com.codeborne.security.digidoc.SignatureModule[] modules) {
        this.modules = modules;
    }

    public com.codeborne.security.digidoc.SignatureModule getModules(int i) {
        return this.modules[i];
    }

    public void setModules(int i, com.codeborne.security.digidoc.SignatureModule _value) {
