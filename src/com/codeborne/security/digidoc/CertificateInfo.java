...
public class CertificateInfo  implements java.io.Serializable {
    ...
    private com.codeborne.security.digidoc.CertificatePolicy[] policies;
    ...
    public CertificateInfo(
           ...
           com.codeborne.security.digidoc.CertificatePolicy[] policies) {
           this.issuer = issuer;
     ...
     * @return policies
     */
    public com.codeborne.security.digidoc.CertificatePolicy[] getPolicies() {
        return policies;
    }
     ...
     * @param policies
     */
    public void setPolicies(com.codeborne.security.digidoc.CertificatePolicy[] policies) {
        this.policies = policies;
    }

    public com.codeborne.security.digidoc.CertificatePolicy getPolicies(int i) {
        return this.policies[i];
    }

    public void setPolicies(int i, com.codeborne.security.digidoc.CertificatePolicy _value) {
