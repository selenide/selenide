...
public class CRLInfo  implements java.io.Serializable {
    ...
    private com.codeborne.security.digidoc.RevokedInfo[] revocations;
    ...
    public CRLInfo(
           ...
           com.codeborne.security.digidoc.RevokedInfo[] revocations) {
           this.issuer = issuer;
     ...
     * @return revocations
     */
    public com.codeborne.security.digidoc.RevokedInfo[] getRevocations() {
        return revocations;
    }
     ...
     * @param revocations
     */
    public void setRevocations(com.codeborne.security.digidoc.RevokedInfo[] revocations) {
        this.revocations = revocations;
    }

    public com.codeborne.security.digidoc.RevokedInfo getRevocations(int i) {
        return this.revocations[i];
    }

    public void setRevocations(int i, com.codeborne.security.digidoc.RevokedInfo _value) {
