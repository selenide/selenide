...
public class DigiDocService_ServiceLocator extends org.apache.axis.client.Service implements com.codeborne.security.digidoc.DigiDocService_Service {
 ...
 */
    ...
    public com.codeborne.security.digidoc.DigiDocServicePortType getDigiDocService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.codeborne.security.digidoc.DigiDocServiceStub _stub = new com.codeborne.security.digidoc.DigiDocServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.codeborne.security.digidoc.DigiDocServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.codeborne.security.digidoc.DigiDocServiceStub _stub = new com.codeborne.security.digidoc.DigiDocServiceStub(new java.net.URL(DigiDocService_address), this);
                _stub.setPortName(getDigiDocServiceWSDDServiceName());
                return _stub;
            }
        }
