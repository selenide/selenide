...
public class SignedDocInfo  implements java.io.Serializable {
    ...
    private com.codeborne.security.digidoc.DataFileInfo[] dataFileInfo;

    private com.codeborne.security.digidoc.SignatureInfo[] signatureInfo;
    ...
    public SignedDocInfo(
           ...
           com.codeborne.security.digidoc.DataFileInfo[] dataFileInfo,
           com.codeborne.security.digidoc.SignatureInfo[] signatureInfo) {
           this.format = format;
     ...
     * @return dataFileInfo
     */
    public com.codeborne.security.digidoc.DataFileInfo[] getDataFileInfo() {
        return dataFileInfo;
    }
     ...
     * @param dataFileInfo
     */
    public void setDataFileInfo(com.codeborne.security.digidoc.DataFileInfo[] dataFileInfo) {
        this.dataFileInfo = dataFileInfo;
    }

    public com.codeborne.security.digidoc.DataFileInfo getDataFileInfo(int i) {
        return this.dataFileInfo[i];
    }

    public void setDataFileInfo(int i, com.codeborne.security.digidoc.DataFileInfo _value) {
     ...
     */
    public com.codeborne.security.digidoc.SignatureInfo[] getSignatureInfo() {
        return signatureInfo;
    }
     ...
     * @param signatureInfo
     */
    public void setSignatureInfo(com.codeborne.security.digidoc.SignatureInfo[] signatureInfo) {
        this.signatureInfo = signatureInfo;
    }

    public com.codeborne.security.digidoc.SignatureInfo getSignatureInfo(int i) {
        return this.signatureInfo[i];
    }

    public void setSignatureInfo(int i, com.codeborne.security.digidoc.SignatureInfo _value) {
