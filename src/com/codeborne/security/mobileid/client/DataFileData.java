...
public class DataFileData  implements java.io.Serializable {
    ...
    private com.codeborne.security.mobileid.client.DataFileAttribute[] attributes;

    private java.lang.String dfData;
    ...
    public DataFileData(
           ...
           int size,
           com.codeborne.security.mobileid.client.DataFileAttribute[] attributes,
     ...
     * @return attributes
     */
    public com.codeborne.security.mobileid.client.DataFileAttribute[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(com.codeborne.security.mobileid.client.DataFileAttribute[] attributes) {
        this.attributes = attributes;
    }

    public com.codeborne.security.mobileid.client.DataFileAttribute getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, com.codeborne.security.mobileid.client.DataFileAttribute _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DataFileData)) return false;
        DataFileData other = (DataFileData) obj;
        ...
        _equals = true && 
            ...
            ((this.dfData==null && other.getDfData()==null) || 
             (this.dfData!=null &&
              this.dfData.equals(other.getDfData())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DataFileData.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl", "DataFileData"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dfData");
        elemField.setXmlName(new javax.xml.namespace.QName("", "DfData"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
